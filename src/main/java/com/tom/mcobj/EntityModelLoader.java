...
public class EntityModelLoader {
	...
	public void loadModels(){
		...
		for(Identifier entry : this.resourceManager.findResources("models/tesr", s -> s.getPath().endsWith(".json")).keySet()){
			...
			iresource = null;
			try {
				iresource = this.resourceManager.getResource(entry).orElse(null);
